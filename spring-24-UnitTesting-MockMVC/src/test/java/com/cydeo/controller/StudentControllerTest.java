...
public class StudentControllerTest {
    ...
    void getStudent_Test() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.get("/student")
                ...
                .andDo(print()) // If you don't put this, you cannot see the details when the method passes.
                .andReturn();
    ...
    void jsonAssert_Test() throws Exception {
        ...
        JSONAssert.assertEquals(expected, actual, false); // If you wanna test exact matching, you need to use true instead of false
