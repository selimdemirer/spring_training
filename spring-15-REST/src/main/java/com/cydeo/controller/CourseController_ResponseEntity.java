...
public class CourseController_ResponseEntity {
    ...
    @GetMapping
    public ResponseEntity<List<CourseDTO>> getAllCourses(){ //ResponseEntity class is coming from Spring. I can pass headers, manipulate my status code with this class.
    ...
    public ResponseEntity<List<CourseDTO>> getCourseByCategory(@PathVariable("category") String category){
        return ResponseEntity
